...
- Launch screen (2026-09-15, spec §6): `LaunchScreen` (the mark breathing on `--splash-bg`, no text, 1.5s minimum hold, same markup pre-painted in index.html) replaces only the two boot "Loading…" states; in-page loaders stay text.
